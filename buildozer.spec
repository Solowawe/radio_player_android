...
# Зависимости (pip)
requirements = kivy==2.3.1,kivymd==1.1.1,requests,urllib3,androidstorage4kivy,pyjnius==1.6.1

# Фиксируем Python 3.11 (3.12+ несовместим с Pyjnius)
...
# Разрешения Android
android.permissions = INTERNET,ACCESS_NETWORK_STATE,READ_EXTERNAL_STORAGE,WRITE_EXTERNAL_STORAGE,READ_MEDIA_AUDIO,MODIFY_AUDIO_SETTINGS,RECORD_AUDIO
...
# python-for-android — используем стабильную ветку по умолчанию
# develop ветка нестабильна и вызывает ошибки сборки
# p4a.branch = develop
